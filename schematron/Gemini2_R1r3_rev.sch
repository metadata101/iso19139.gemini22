  ...
  <sch:pattern fpi="Gemini2-mi19">
    ...
    <sch:rule context="/*[1]/gmd:distributionInfo/*[1]/gmd:transferOptions/*[1]/gmd:onLine/*[1]">
      <sch:assert test="count(gmd:linkage) = 0 or
        ...
        The value of the resource locator does not appear to be a valid URL. It has a value of '<sch:value-of select="gmd:linkage/*[1]"/>'. The URL must start with either http://, https:// or ftp://.
      </sch:assert>
    </sch:rule>
  </sch:pattern>
