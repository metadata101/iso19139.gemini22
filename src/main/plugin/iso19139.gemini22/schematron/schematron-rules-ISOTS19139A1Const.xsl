...
<xsl:choose>
   ...
   <!--PATTERN Dataset Topic Category-->
...
<xsl:choose>
   ...
   <!--PATTERN Constraints: Other Restrictions-->
...
<xsl:choose>
   ...
   <!--PATTERN Dataset or Series Lineage-->
...
<xsl:choose>
   ...
   <!--PATTERN Lineage Source and ProcessStep-->
...
<xsl:choose>
   ...
   <!--PATTERN MD_Georectified: checkPointAvailability-->
...
<xsl:choose>
   ...
   <!--PATTERN MD_Band: maxValue and minValue-->
...
<xsl:choose>
   ...
   <!--PATTERN Distance Unit of Measurement-->
...
<xsl:choose>
   ...
   <!--PATTERN Length Unit of Measurement-->
...
<xsl:choose>
   ...
   <!--PATTERN Scale Unit of Measurement-->
...
<xsl:choose>
   ...
   <!--PATTERN Angle Unit of Measurement-->
...
<xsl:template match="//*" priority="1000" mode="M47">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="//*"/>
		    ...
		    <!--ASSERT -->
<xsl:choose>
         <xsl:when test="count(*) &gt; 0 or                   namespace-uri() = 'http://www.isotc211.org/2005/gco' or                   namespace-uri() = 'http://www.isotc211.org/2005/gmx' or                   namespace-uri() = 'http://www.opengis.net/gml/3.2' or                   namespace-uri() = 'http://www.opengis.net/gml' or                   namespace-uri() = 'http://www.fao.org/geonetwork' or                   @codeList or                   @codeListValue or                   local-name() = 'MD_TopicCategoryCode' or                   local-name() = 'URL' or                   (@gco:nilReason = 'inapplicable' or                   @gco:nilReason = 'missing' or                   @gco:nilReason = 'template' or                   @gco:nilReason = 'unknown' or                   @gco:nilReason = 'withheld') or                   @xlink:href"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" ref="#_{geonet:element/@ref}"
                                test="count(*) &gt; 0 or namespace-uri() = 'http://www.isotc211.org/2005/gco' or namespace-uri() = 'http://www.isotc211.org/2005/gmx' or namespace-uri() = 'http://www.opengis.net/gml/3.2' or namespace-uri() = 'http://www.opengis.net/gml' or namespace-uri() = 'http://www.fao.org/geonetwork' or @codeList or @codeListValue or local-name() = 'MD_TopicCategoryCode' or local-name() = 'URL' or (@gco:nilReason = 'inapplicable' or @gco:nilReason = 'missing' or @gco:nilReason = 'template' or @gco:nilReason = 'unknown' or @gco:nilReason = 'withheld') or @xlink:href">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>
