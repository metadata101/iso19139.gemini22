...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
			...
			<dataQualityInfo>
				<DQ_DataQuality>
					...
					<lineage>
						<LI_Lineage>
							<statement>
								<gco:CharacterString>Data captured with reference to Ordnance Survey Mastermap topographic data.
								</gco:CharacterString>
							</statement>
						</LI_Lineage>
					</lineage>
	...
	<xsl:template match="ows:ServiceIdentification">
		...
		<purpose>
			<gco:CharacterString>
				<xsl:for-each select="//ows:Constraint[@name='SupportedISOQueryables' or @name='AdditionalQueryables']/ows:Value">
		...
		<xsl:for-each-group select="//ows:Parameter[@name='outputSchema']/ows:Value" group-by=".">
			<resourceFormat>
				<MD_Format>
					<name><gco:CharacterString><xsl:value-of select="."/></gco:CharacterString></name>
					<version gco:nilReason="inapplicable"><gco:CharacterString/></version>
				</MD_Format>
			</resourceFormat>
		</xsl:for-each-group>
		...
		<resourceConstraints>
			<MD_LegalConstraints>
				...
				<otherConstraints>
					<gco:CharacterString><xsl:value-of select="ows:AccessConstraints"/></gco:CharacterString>
				</otherConstraints>
			</MD_LegalConstraints>
		</resourceConstraints>
